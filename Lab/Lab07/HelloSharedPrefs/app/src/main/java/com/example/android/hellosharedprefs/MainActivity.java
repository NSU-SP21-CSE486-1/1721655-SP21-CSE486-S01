...
public class MainActivity extends AppCompatActivity {
    public static final String COLOR_S = "com.example.android.hellosharedprefs.extra.COLOR";
    public static final String COUNT_S = "com.example.android.hellosharedprefs.extra.COUNT";
    // Current count
...
*/
    ...
    public void settingsLaunch(View view) {
        ...
        intent.putExtra(COUNT_S,String.format("%s", mCount));
        intent.putExtra(COLOR_S,String.format("%s", mColor));
